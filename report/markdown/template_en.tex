...
\vspace{1.5cm}
\fontsize{16}{24}\selectfont{$date_en$\par}
\vspace{2cm}
\end{center}
\end{titlepage}
...
\fontsize{14}{21}\selectfont{
    \leftline{Student: $author_en$} \par
    \leftline{Advisor: $advisor_en$} \par
}
\vspace{1.75cm}
...
\vspace{\fill}
\fontsize{14}{21}\selectfont{$date_en$\par}
\vspace{2cm}
\end{center}
\end{titlepage}
$endif$
...
\addcontentsline{toc}{chapter}{$symbols_title$}
...
\chapter*{$curriculum_vitae_title$}
\addcontentsline{toc}{chapter}{$curriculum_vitae_title$}
\begin{center}
\begin{tabular}{||l|l||}
\hline
\multicolumn{2}{||c||}{\includegraphics{$mug$}} \\ \hline
Name                  & $author_en$ \\ \hline
Gender                & $gender$ \\ \hline
Date of birth         & $birth$ \\ \hline
Birthplace            & $birthplace$ \\ \hline
Highest education     & \begin{tabular}[x]{@{}l@{}}
                            $institute_en$ Master \\
                            from $university_en$
                        \end{tabular} \\ \hline
Secondary education   & \begin{tabular}[x]{@{}l@{}}
                            $institute_en$ \\
                            from $university_en$
                        \end{tabular} \\ \hline
Research              & $title_en$ \\ \hline
\multicolumn{2}{||l||}{Published papers} \\ \hline
$for(papers)$ \multicolumn{2}{||p{0.6\paperwidth}||}{$papers$} \\ \hline $endfor$
\multicolumn{2}{||l||}{Professional licenses} \\ \hline
$for(papers)$ \multicolumn{2}{||p{0.6\paperwidth}||}{$licenses$} \\ \hline $endfor$
\end{tabular}
\end{center}
\vspace{\fill}
$endif$
